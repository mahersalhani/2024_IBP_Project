...
export const OTPForm = ({
  ...
  return inputsRefs.map((ref, i) => (
    <input
      className="spin-button-none w-full h-full flex flex-col items-center justify-center text-center outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-blue-700"
